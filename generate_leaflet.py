...
def generate_leaflet_pdf(json_path='menu.json', template_path='leaflet_template.html', output_pdf='fumo33_leaflet_menu.pdf'):
    """Read menu data, render HTML template, and write to high-quality print PDF leaflet."""
    ...
    print("Step 2: Loading A4 Landscape HTML leaflet layout template...")
    ...
    temp_html_path = os.path.abspath('temp_leaflet_render.html')
    with open(temp_html_path, 'w', encoding='utf-8') as f:
        f.write(rendered_html)

    print("Step 4: Launching headless browser to print vector A4 Landscape leaflet PDF...")
    ...
    try:
        with sync_playwright() as p:
            ...
            # Print to PDF using @page CSS size rules (A4 landscape, margins, color accuracy)
            page.pdf(
                path=output_pdf,
        ...
        print(f"Success! A4 Landscape Leaflet menu generated: '{output_pdf}'")
        return True
