...
def generate_drinks_pdf(json_path='drinks_menu.json', template_path='drinks_template.html', output_pdf='fumo33_drinks_menu.pdf'):
    """Read drinks menu data, render HTML template, and write to high-quality print PDF."""
    print("Step 1: Reading Fumo 33 drinks menu database...")
    ...
    print("Step 2: Loading A3 HTML drinks template...")
    ...
    rendered_html = template.render(data=drinks_data)

    # Write temporary rendered HTML file to disk so Playwright can read it local-file style
    temp_html_path = os.path.abspath('temp_drinks_render.html')
    with open(temp_html_path, 'w', encoding='utf-8') as f:
        f.write(rendered_html)

    print("Step 4: Launching headless browser to print vector A3 drinks PDF...")
    ...
    try:
        ...
        print(f"Success! A3 Print-ready drinks & snacks menu generated: '{output_pdf}'")
        return True
